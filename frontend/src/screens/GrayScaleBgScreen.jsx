...
import {
  ...
  fetchGetGrayScaleBg,
  grayScaleBgReset,
} from "@/features/GrayScaleBgSlice";
...
function GrayScaleBgScreen() {
  ...
  const getGrayScaleBg = useSelector(
    (state) => state.grayScaleBg.getGrayScaleBg
  );
  const grayScaleBgStatus = useSelector(
    (state) => state.grayScaleBg.grayScaleBgStatus
  );
  const getGrayScaleBgStatus = useSelector(
    (state) => state.grayScaleBg.getGrayScaleBgStatus
  );
            ...
            <CardContent>
              <div className="flex flex-col space-y-4 my-2 items-center ">
                <div className="flex flex-col items-center space-y-2 text-sm md:text-base">
                  <p>
                    Before uploading the image choose the image type if both are
                    not working use other
                  </p>
            ...
            <CardFooter>
              {getGrayScaleBgStatus === "succeeded" && (
                <div className="flex flex-col w-full space-y-4">
                  ...
                  <a
                    href={grayScaleBgImage}
                    download={`grayScaleBgImage.png`}
                    className="w-full"
                  >
