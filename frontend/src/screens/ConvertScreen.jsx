...
function ConvertScreen() {
  ...
  const getConvertStatus = useSelector(
    (state) => state.convert.getConvertStatus
  );
            ...
            <CardContent>
              <div className="h-full flex flex-col space-y-4 my-2 items-center">
                <div className="flex flex-col items-center space-y-2 text-sm md:text-base">
                  <p>
                    Before uploading the image choose format pdf and tiff format
                    not supported to show the image
                  </p>
