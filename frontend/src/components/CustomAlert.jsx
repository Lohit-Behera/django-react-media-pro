...
function CustomAlert({ title = '', description = '', variant = 'success', setOpenProp = false }) {
    ...
    return (
        <div>
            <Alert variant={variant} className={`fixed top-20 right-3 md:right-20 text-base md:text-lg mx-auto p-4 z-50 pointer-events-none max-w-sm md:min-w-fit ${!out && 'animate-slide-in-from-top'} ${out && 'animate-slide-out-to-top'} ${hide && 'hidden'} `}>
