"""
URL configuration for djangomediapro project.
...
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) + static(settings.ASSETS_URL, document_root=settings.ASSETS_ROOT)
